...
get_cover_book_path = '/app/backend/docs/books/get_cover_book_swagger.yml'
delete_book_path = '/app/backend/docs/books/delete_book_swagger.yml'
download_book_path = '/app/backend/docs/books/download_book_swagger.yml'
