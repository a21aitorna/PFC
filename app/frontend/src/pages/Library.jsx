...
export default function Library() {
  ...
  return (
    <Background>
      ...
      <div className="flex flex-col md:flex-row w-full max-w-7xl mt-24 mb-16 px-6 space-y-6 md:space-y-0 md:space-x-6">
        ...
        {/* Sección principal */}
        <main className="flex-1 bg-white/90 rounded-2xl shadow-lg p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-lg font-semibold text-gray-800">
              Mi Librería <span className="text-sm text-gray-500">({filteredBooks.length} libros)</span>
            </h2>
